                ...
                <Carousel  arrows>
                    <div className="content">
                        <div className="content__wrapper">
                            <img className="content__bg"  style={{backgroundImage: 'url(static/images/about/slider/aboutClubs.jpg'}} />
                    ...
                    <div className="content">
                        <div className="content__wrapper">
                                 <img className="content__bg"  style={{backgroundImage: 'url(static/images/about/slider/maraton.jpg)'}} />
                    ...
                    <div className="content">
                        <div className="content__wrapper">
                            <img className="content__bg"  style={{backgroundImage: 'url(static/images/about/slider/aboutUs.jpg'}} />
                            <h1>Про нас</h1>
