...
<div style=""text"-align-last: center;display: table;
    "text"-align: center;"> <img  style="width: 240px" src=/src/images/marathon/taskData/day16_1.png></img>
<img  style="width: 240px" src=/src/images/marathon/taskData/day16_2.png></img>
</div>
...
<div style=""text"-align-last: center;display: table;
    "text"-align: center;"> <img  style="width: 240px" src=/src/images/marathon/taskData/day16_3.png></img>
<img  style="width: 240px" src=/src/images/marathon/taskData/day16_4.png></img>
</div>
...
<div style=""text"-align: -webkit-center;"> <img  style="width: 75%; align-self: center" src=/src/images/marathon/taskData/day17_1.png></img></div>
...
`,
    taskTitle: `Завдання`,
    task:
      "Пам’ятаєте дитячу розвагу ворожити на книгах? Ставите запитання, яке вас турбує, тоді кажете вголос сторінку і номер рядка. Сьогодні пограємось: візьміть будь-яку книжку українською мовою, яка у вас є, відкрийте сторінку 30, рядок 10, прочитайте відповідь на запитання «Про що буде наступний вебінар Мовомаратону» і поділіться в чаті, що у вас вийшло." +
  ...
  },
  {
    ...
    subheader: "",
    text:
      "Розуміння історії допоможе зрозуміти процеси, що відбуваються зараз, в тому числі і дати відповідь на питання “чому ми так говоримо”." +
  ...
  },
  {
    ...
    subheader: "",
    text:
      "НАДИХА́ТИСЯ - відчувати приплив сил, бадьорості, душевного піднесення під впливом чого-небудь." +
    ...
    text2:
      `Сьогодні - передостанній день Мовомаратону і ми вже трохи сумуємо. Однак в епоху соцмереж ми можемо не зникати з життя один одного, а продовжувати творити спільноту, яка зветься Україна, шукати натхнення в українській мові і культурі, творити українською.` +
    ...
    taskTitle: `Завдання`,
    task:
      "Пам’ятаєте, у другий день Мовомаратону було завдання написати мотиваційний лист самому собі і відповісти на питання: що вас мотивує говорити українською? хто може вас підтримати? якою чи яким ви хочете бути після 30 днів Мовомаратону? Знайдіть цей лист, поверніться до нього. Що змінилось за ці чотири тижні? Допишіть цей лист. Якою чи яким ви хочете бути через пів року чи рік? Що вас мотивує говорити українською?" +
  ...
  },
  {
    ...
    subheader: "",
    text:
      "Друзі, вітаємо! Відчуйте себе переможцями - ви подолали ці тридцять днів Мовомаратону до 30-річчя Незалежності України! Ви це змогли! Ми радіємо разом з вами! Сподіваємось, що ви отримали за ці тридцять днів цінне - досвід, практику і однодумців." +
    ...
    text2:
      `<span "id"="headline">Вебінари:</span>` +
