      ...
      render() {
          return (
            ...
            <Steps
                ...
                <Step style={{display: (this.props.current == 1 || this.props.current == 2 || this.props.current == 3) ? "block" : "none", textAlign:(this.props.current == 1)?"right":"left"}} title="Опис"></Step>
