        ...
        return (
            ...
            <div className="form-fields">
                <Form.Item name="urlLogo"
                    ...
                    >
                        <span className="addCenter-upload"><UploadOutlined className="upload-icon"/>Завантажити лого</span>
                    </Upload>
                </Form.Item>
                <Form.Item name="urlBackground"
                    ...
                    <Upload
                        ...
                        headers={{contentType: 'multipart/form-data'}}
                    >
                        <span className="addCenter-upload"><UploadOutlined className="upload-icon"/>Завантажити фото</span>
                    </Upload>
                </Form.Item>
