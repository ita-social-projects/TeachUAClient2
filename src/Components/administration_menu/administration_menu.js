...
import "./administration-menu.scss";
  ...
  render() {
    return (
      <Menu mode="vertical" className='menu-administration'>
        <SubMenu key="sub_administration" title="Адміністрування" className='sub-menu-administration'>
          <Menu.Item className='sub-menu-administration' key="2">Райони</Menu.Item>
          <Menu.Item className='sub-menu-administration' key="3">Станції/Місцевості</Menu.Item>
          <Menu.Item className='sub-menu-administration' key="4">Категорії</Menu.Item>
          ...
          <Menu.Item className='sub-menu-administration' key="1">Міста</Menu.Item>
